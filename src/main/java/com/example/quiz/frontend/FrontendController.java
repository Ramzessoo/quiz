...
public class FrontendController {
    ...
    @PostMapping("/select")
    public String postSelectModel(Model model, @ModelAttribute GameOptions gameOptions) {
    ...
    @PostMapping("/game")
    public String portSelectFrom(Model model, @ModelAttribute UserAnswer userAnswer) {
